...
# v3.2.0 выпущен для тестирования https://nikolaevich23.github.io/t
### Плагин:
...
### Полезная нагрузка:
-Добавлено: обнаружение пэдов (удерживайте R2, чтобы отключить boot_plugins.txt - бывает полезно, когда плагины вешают пс3)

...
## Изменения в 3.3.5 тестовая версия
...
- Добавлен новый метод обновления иконки хен (через релогин)
...
- Пункты управления реестром вынесены в отдельную категорию (некоторые пункты внутри пока заглушки - на будущее).
- Пункты управления плагинами вынесены в отдельную категорию.
- В раздел ретро добавлена категория лаунчеров.
- Добавлена новая опция переключения через релогин в инструменты хен - интерфейс.
- В инструменты информации и сохранения добавлены:
- пункт просмотра лога syscon ошибок;
- пункт декодирования redump образов (пока заглушка);

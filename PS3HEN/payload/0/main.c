...
int main(void)
{
	...
	//{
		...
		map_path("/dev_flash/vsh/resource/explore/icon/hen_disabled.png","/dev_flash/vsh/resource/AAA/hen_enabled.png",FLAG_MAX_PRIORITY|FLAG_PROTECT); // Enable HFW Tools on Launch 2.3.3+
		map_path("/dev_hdd0/hen/hfw_settings.xml","/dev_flash/hen/xml/hfw_settings.xml",FLAG_MAX_PRIORITY|FLAG_PROTECT); // Show PKG Manager
		map_path("/dev_hdd0/hen/package_manager.xml","/dev_flash/hen/xml/package_manager.xml",FLAG_MAX_PRIORITY|FLAG_PROTECT); // Hide Enable HEN Menu Item
	//}

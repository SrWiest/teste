...
mv *CEX_484 *CEX_485 *CEX_486 *CEX_487 *CEX_488 *CEX_489 *CEX_490 PS3HEN_GEN
cd henplugin
...
rm -f *.o *.elf *.self ../lv1/src/*.o ../debug/src/*.o ../lv2/src/*.o
cd ..
mv  *484C *485C *486C *487C *488C *489C *490C PS3HEN_GEN
cd PS3HEN_GEN
gcc main.c -o HEN_GEN
HEN_GEN PS3HEN.BIN_CEX_484 stage2.bin_debug_484C stage0.bin_484C HENplugin.sprx
HEN_GEN PS3HEN.BIN_CEX_485 stage2.bin_debug_485C stage0.bin_485C HENplugin.sprx
HEN_GEN PS3HEN.BIN_CEX_486 stage2.bin_debug_486C stage0.bin_486C HENplugin.sprx
HEN_GEN PS3HEN.BIN_CEX_487 stage2.bin_debug_487C stage0.bin_487C HENplugin.sprx
HEN_GEN PS3HEN.BIN_CEX_488 stage2.bin_debug_488C stage0.bin_488C HENplugin.sprx
HEN_GEN PS3HEN.BIN_CEX_489 stage2.bin_debug_489C stage0.bin_489C HENplugin.sprx
HEN_GEN PS3HEN.BIN_CEX_490 stage2.bin_debug_490C stage0.bin_490C HENplugin.sprx
rm stage* *.sprx *.exe
mv PS3HEN* ../
pause